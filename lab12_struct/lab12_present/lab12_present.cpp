...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine,  _In_ int nCmdShow) {
    ...
    LoadStringW(hInstance, IDC_LAB12PRESENT, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LAB12PRESENT));
    MSG msg;
...
ATOM MyRegisterClass(HINSTANCE hInstance) {
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LAB12PRESENT));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_LAB12PRESENT);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow) {
   ...
   FILE *f;
   fopen_s(&f, "C:\\Users\\hexumee\\Desktop\\osnprog_labs\\lab12_struct\\s.bin", "rb");
